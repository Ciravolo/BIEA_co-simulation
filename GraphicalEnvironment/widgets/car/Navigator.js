...
define(function (require, exports, module) {
    ...
    function Navigator(id, coords, opt) {
        ...
        this.defs.append("svg:marker")
                    .attr("id", "end-arrow-" + this.idString)
        ...
        opt.x0 = (isNaN(parseFloat(opt.x0)))? 0.138 : parseFloat(opt.x0);
        opt.y0 = (isNaN(parseFloat(opt.y0)))? -0.08 : parseFloat(opt.y0);
        this.data = [];
        ...
        this.path = svg.append("path")
                        ...
                        .attr("stroke-width", "3")
                        .attr("fill", "none");
        this.path.style("marker-end","url(#end-arrow-" + this.idString + ")");
